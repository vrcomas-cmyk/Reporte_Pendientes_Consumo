...
const SHORTCUTS: { group: string; items: { keys: string; desc: string }[] }[] = [
  {
    ...
    items: [
      ...
      { keys: 'g  y', desc: 'Ir a Hoy' },
      { keys: 'g  c', desc: 'Ir a Carga' },
      { keys: 'g  t', desc: 'Ir a Resultados' },
      { keys: 'g  s', desc: 'Ir a Pedidos' },
      { keys: 'g  o', desc: 'Ir a Consumo' },
      { keys: 'g  n', desc: 'Ir a Inventario' },
      { keys: 'g  i', desc: 'Ir a Inv Condición' },
      { keys: 'g  a', desc: 'Ir a Análisis' },
      { keys: 'g  p', desc: 'Ir a Oportunidades' },
      { keys: 'g  m', desc: 'Ir a Comodato vs. Fac.' },
      { keys: 'g  q', desc: 'Ir a Solicitudes' },
      { keys: 'g  h', desc: 'Ir a Historial' },
      { keys: 'g  l', desc: 'Ir a Registros' },
      { keys: 'g  x', desc: 'Ir a Ajustes' },
    ],
  },
  {
    group: 'Acciones',
