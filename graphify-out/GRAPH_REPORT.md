...
## Summary
- 7753 nodes · 17101 edges · 352 communities (319 shown, 33 thin omitted)
...
## Communities (352 total, 33 thin omitted)
...
Cohesion: 0.08
Nodes (60): Analytics, AnalyticsCtx, useAnalytics(), consFor(), consumoEnrich(), consumoSerie(), consumoStatus(), consumoTend() (+52 more)
...
### Community 7 - "react"
Cohesion: 0.03
Nodes (24): react, Button, ButtonProps, buttonVariants, Input, PopoverContent, Progress, Select (+16 more)

### Community 8 - "analysisService.ts"
Cohesion: 0.16
Nodes (15): buildFromSheetsInWorker(), BuildFromSheetsParams, getWorker(), makeWorker(), nextId(), parseCatalog(), pendingJobs, processReport() (+7 more)
...
Cohesion: 0.11
Nodes (35): buildHeatmap(), computeKpis(), detectInconsistencies(), monthlyInvoicing(), topEjecutivos(), topMateriales(), buildAnalysisResult(), BuildAnalysisResultParams (+27 more)
...
Cohesion: 0.06
Nodes (40): applyCatalogPriceFallback(), computeBloqueados(), condKey(), EMPTY, normCode(), preciosPorCondicion(), buildPrecioDispersion(), PrecioCliente (+32 more)
...
Cohesion: 0.07
Nodes (54): ABC_THRESHOLDS, AbcClass, AbcClassSummary, AbcEntry, buildAbc(), classify(), EMPTY, sum12m() (+46 more)
...
Cohesion: 0.06
Nodes (34): AbcBadge, CLS, TITLE, ClearFiltersButton(), ClienteOportunidadBadge(), CONDICION_LABEL, ActiveFilter, ColumnFilterBar() (+26 more)
...
## Knowledge Gaps
- **1779 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `SEED_MODES` (+1774 more)
