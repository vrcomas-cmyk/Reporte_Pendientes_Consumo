...
## Knowledge Gaps
- **177 isolated node(s):** `ZOOM_LEVELS`, `ZOOM_ROW`, `FilterColumn`, `ActiveFilter`, `CLS` (+172 more)
...
- **What connects `ZOOM_LEVELS`, `ZOOM_ROW`, `FilterColumn` to the rest of the system?**
