...
## Corpus Check
- 511 files · ~781,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7610 nodes · 16724 edges · 355 communities (320 shown, 35 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 329 edges (avg confidence: 0.69)
...
## Communities (355 total, 35 thin omitted)
...
Cohesion: 0.11
Nodes (33): Analytics, AnalyticsCtx, consFor(), consumoEnrich(), consumoSerie(), consumoStatus(), consumoTend(), matchesQuery() (+25 more)
...
### Community 7 - "react"
Cohesion: 0.03
Nodes (22): react, EmptyState, EmptyStateProps, Badge, BadgeProps, badgeVariants, Input, PopoverContent (+14 more)
...
Cohesion: 0.10
Nodes (34): buildHeatmap(), detectInconsistencies(), monthlyInvoicing(), topEjecutivos(), topMateriales(), buildAnalysisResult(), BuildAnalysisResultParams, findSheetByRole() (+26 more)

### Community 91 - "@duckdb/duckdb-wasm"
Cohesion: 0.07
Nodes (36): applyCatalogPriceFallback(), computeBloqueados(), computeKpis(), condKey(), buildPrecioDispersion(), PrecioCliente, PrecioDispersionEntry, BloqueadoMotivo (+28 more)

### Community 92 - "mappers.ts"
Cohesion: 0.11
Nodes (15): ClienteConocimientoPanel, MaterialHubPanel, OportunidadPanel, PanelHost(), PANELS, WIDE, ClienteDetallePanel(), ConsumoMaterialPanel() (+7 more)
...
Cohesion: 0.15
Nodes (19): xlsx, mapEjecutivo(), mapMaterial(), exportXlsx(), exportXlsxMultiSheet(), cancelled, firstRowHeaders(), fixRange() (+11 more)
...
Cohesion: 0.06
Nodes (34): AbcBadge, CLS, TITLE, ClearFiltersButton(), ActiveFilter, ColumnFilterBar(), FilterColumn, passesFilters() (+26 more)

### Community 342 - "AnalisisPage.tsx"
Cohesion: 0.83
...
## Knowledge Gaps
- **1741 isolated node(s):** `REPORT_SHEETS_URL_ENV`, `REPORT_TABS`, `REPORT_SHEET_ROLES`, `SNAPSHOT_ROLES`, `progressListeners` (+1736 more)
...
- **Are the 43 inferred relationships involving `el()` (e.g. with `browserFindingsFromMap()` and `collectVisualContrastCandidates()`) actually correct?**
  _`el()` has 43 INFERRED edges - model-reasoned connections that need verification._
- **What connects `REPORT_SHEETS_URL_ENV`, `REPORT_TABS`, `REPORT_SHEET_ROLES` to the rest of the system?**
