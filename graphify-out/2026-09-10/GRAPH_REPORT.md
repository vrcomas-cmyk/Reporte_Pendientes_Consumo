...
## Corpus Check
- 553 files · ~827,246 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7916 nodes · 17367 edges · 364 communities (327 shown, 37 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 344 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0fead7ec`
...
- SupabaseReglaAceptacionRepository
- Android platform
- Generate Report
...
Cohesion: 0.10
Nodes (50): Analytics, AnalyticsCtx, buildConsumoIndex(), consumoEnrich(), consumoKey(), consumoSerie(), consumoStatus(), consumoTend() (+42 more)
...
### Community 7 - "react"
Cohesion: 0.02
Nodes (37): react, EmptyState, EmptyStateProps, Badge, BadgeProps, badgeVariants, ContextMenuContent, ContextMenuItem (+29 more)
...
Cohesion: 0.07
Nodes (38): buildClientes(), buildConcentracion(), buildEscenarios(), buildIncrementoImpacto(), buildPeriodo(), buildSerieImpactoMensual(), clasificarRentabilidad(), ClienteImpacto (+30 more)
...
Cohesion: 0.08
Nodes (22): AdminPage, AnalisisPage, App(), ClientesPage, ComodatoPage, ConsumoPage, DashboardPage, HistoryPage (+14 more)
...
Cohesion: 0.05
Nodes (39): CICLO_OPORTUNIDAD, ESTADOS_OPORTUNIDAD, ClienteRow, ClientesTab(), CONDICION_LABEL, ESTADO_LABEL, CargaMasivaDialog(), DestinatarioLite (+31 more)
...
Cohesion: 0.11
Nodes (17): MOTIVOS_RECHAZO, ClienteFicha(), ClienteFichaForm(), emptyFicha(), CATEGORIAS, CondicionSelector(), ObservacionesList(), CONDICIONES (+9 more)
...
### Community 95 - "react"
Cohesion: 0.05
Nodes (60): applyCatalogPriceFallback(), computeBloqueados(), computeKpis(), condKey(), detectInconsistencies(), monthlyInvoicing(), topEjecutivos(), topMateriales() (+52 more)
...
Cohesion: 0.09
Nodes (49): getLiveAnnotationsDir(), getLiveDir(), isLiveServerPidReachable(), resolveLiveTemplateExtensions(), acceptCli(), acceptReceiptPath(), argVal(), buildAcceptedWrappedSource() (+41 more)

### Community 146 - "resolveVarRefs"
Cohesion: 0.05
Nodes (79): ABC_THRESHOLDS, AbcClass, AbcClassSummary, AbcEntry, AbcPredicates, AbcResult, buildAbc(), classify() (+71 more)
...
Cohesion: 0.09
Nodes (29): norm(), num(), numLoose(), useAnalytics(), consFor(), sugFor(), ClienteConocimientoPanel, ClientesSinReglaPanel (+21 more)
...
Cohesion: 0.14
Nodes (20): parseCliOptions(), resolveProjectRoot(), firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveAnnotationsDir(), getLegacyLiveConfigPath() (+12 more)
...
Cohesion: 0.14
Nodes (23): extractPlatform(), extractSectionValue(), hasVisualImplementation(), loadContext(), cli(), COMMON_DEV_PORTS, devServerSignals(), gatherSignals() (+15 more)
...
Cohesion: 0.15
Nodes (20): buildAnalysisResult(), excelDateToIso(), mapConsumo(), mapEjecutivo(), mapIncrementoCosto(), mapInvConsolidado(), mapInvDetalle(), mapMaterial() (+12 more)
...
### Community 315 - "PasteCodesFilter.tsx"
Cohesion: 0.46
Nodes (6): matchesAnyCode(), matchesCodes(), parseCodesPaste(), PasteCodesChip(), PasteCodesFilter(), upperSet()

### Community 317 - "captureElementToBlob"
Cohesion: 0.32
Nodes (8): borderColorsFromStyle(), borderWidthsFromStyle(), checkElementGptBorderShadow(), checkElementGptBorderShadowDOM(), checkGptThinBorderWideShadow(), cssColorAlpha(), shadowLayerAlpha(), shadowMaxBlurPx()
...
Cohesion: 0.28
Nodes (8): ActiveFilter, FilterColumn, normalizeFilters(), passesFilters(), valuesOf(), ColumnValuesPicker(), columns, Row

### Community 342 - "DateRangeFilter.tsx"
Cohesion: 0.53
Nodes (4): DateField(), dmyToIso(), isoToDmy(), maskDmy()
...
### Community 349 - "LocalClienteConocimientoRepository"
Cohesion: 0.40
...
### Community 353 - "normalizeGitHubEvent"
Cohesion: 0.38
Nodes (7): applyPatchText(), envProjectDir(), looksLikeApplyPatch(), normalizeGitHubEvent(), normalizeHookEvent(), parseGitHubToolArgs(), resolveProjectCwd()
...
### Community 355 - "button.tsx"
Cohesion: 0.50
Nodes (3): Button, ButtonProps, buttonVariants

### Community 357 - "tabs.tsx"
Cohesion: 0.50
Nodes (3): TabsContent, TabsList, TabsTrigger

### Community 358 - "context-menu.tsx"
Cohesion: 0.83
Nodes (3): AnalisisPage(), pct(), qLabelOf()

## Knowledge Gaps
- **1820 isolated node(s):** `1. Columnas esperadas en la pestaña `IncrementoCostos``, `2. Crear el script`, `3. Publicar como Web App`, `4. Configurar el conector en el portal`, `5. Qué NO cambia` (+1815 more)
...
- **Are the 43 inferred relationships involving `el()` (e.g. with `browserFindingsFromMap()` and `collectVisualContrastCandidates()`) actually correct?**
  _`el()` has 43 INFERRED edges - model-reasoned connections that need verification._
- **What connects `1. Columnas esperadas en la pestaña `IncrementoCostos``, `2. Crear el script`, `3. Publicar como Web App` to the rest of the system?**
