...
## Summary
- 7916 nodes · 17505 edges · 354 communities (321 shown, 33 thin omitted)
...
Cohesion: 0.10
Nodes (31): AbcClass, buildAnalisisPredicates(), normCode(), buildClientes(), buildConcentracion(), buildEscenarios(), buildIncrementoImpacto(), buildSerieImpactoMensual() (+23 more)
...
### Community 95 - "react"
Cohesion: 0.06
Nodes (57): applyCatalogPriceFallback(), computeBloqueados(), computeKpis(), condKey(), detectInconsistencies(), monthlyInvoicing(), topEjecutivos(), topMateriales() (+49 more)
...
Cohesion: 0.08
Nodes (29): buildEnrich(), IncrementoContext, EMPTY_CATALOG, mkCtx(), mkMaterial(), mkRss(), excelDateToIso(), mapEjecutivo() (+21 more)
