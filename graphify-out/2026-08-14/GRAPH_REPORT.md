# Graph Report - Reporte_Pendientes_Consumo  (2026-08-14)

## Corpus Check
- 510 files · ~778,578 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7597 nodes · 16810 edges · 352 communities (318 shown, 34 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 333 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `298230fd`
...
## Communities (352 total, 34 thin omitted)
...
Cohesion: 0.09
Nodes (57): Analytics, AnalyticsCtx, useAnalytics(), consFor(), consumoEnrich(), consumoSerie(), consumoStatus(), consumoTend() (+49 more)
...
### Community 7 - "react"
Cohesion: 0.02
Nodes (24): react, EmptyState, EmptyStateProps, Badge, BadgeProps, badgeVariants, Input, PopoverContent (+16 more)
...
Cohesion: 0.13
Nodes (22): backoffDelay(), byPriority(), checkForReportSheetsUpdate(), fetchReportSheetsMeta(), fetchReportSheetTab(), fetchReportSheetTabOnce(), fetchReportSheetTabPaginated(), pageSizeFor() (+14 more)
...
Cohesion: 0.08
Nodes (35): applyEditing(), buildLocatorForLeaf(), buildPlaceholderResizeHandles(), canRestoreManualEditElement(), copyEditContainerContext(), copyEditLeafContext(), cursorForPlaceholderEdge(), directMixedTextRestoreNodes() (+27 more)
...
### Community 44 - "dexie"
Cohesion: 0.10
Nodes (35): detectUrl(), measureContentHiddenAfterReveal(), runVisualContrastFallback(), serializeDesignSystemForBrowser(), runTextContentAnalyzers(), collectStaticCssText(), checkStaticPageTypography(), detectHtml() (+27 more)
...
Cohesion: 0.07
Nodes (73): applyParamDefaults(), applyParamValue(), applyPlaceholderDimensions(), applySavedSessionMeta(), checkpointPayload(), clampVariantIndex(), clearHandled(), closedClipPath() (+65 more)
...
Cohesion: 0.06
Nodes (53): checkClippedOverflow(), checkElementClippedOverflow(), checkElementClippedOverflowDOM(), checkElementHeroEyebrow(), checkElementHeroEyebrowDOM(), checkElementItalicSerif(), checkElementItalicSerifDOM(), checkElementMotion() (+45 more)
...
Cohesion: 0.12
Nodes (30): buildHeatmap(), detectInconsistencies(), monthlyInvoicing(), topEjecutivos(), topMateriales(), buildAnalysisResult(), BuildAnalysisResultParams, findSheetByRole() (+22 more)

### Community 91 - "@duckdb/duckdb-wasm"
Cohesion: 0.06
Nodes (40): applyCatalogPriceFallback(), computeBloqueados(), computeKpis(), condKey(), EMPTY, normCode(), preciosPorCondicion(), buildPrecioDispersion() (+32 more)
...
Cohesion: 0.08
Nodes (55): extractPlatform(), hasVisualImplementation(), loadContext(), applyFixes(), cli(), collect(), parseArgs(), readProjectRootPatterns() (+47 more)
...
Cohesion: 0.12
Nodes (33): checkColors(), checkCreamPalette(), checkElementAIPaletteDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM(), checkElementHoverContrast(), checkElementIconTile() (+25 more)
...
Cohesion: 0.21
Nodes (13): firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveConfigPath(), getLegacyLiveServerPath(), getLiveAnnotationsDir(), getLiveConfigPath() (+5 more)
...
Cohesion: 0.15
Nodes (20): xlsx, mapEjecutivo(), mapMaterial(), exportXlsx(), exportXlsxMultiSheet(), syncCatalogFromAppScript(), cancelled, firstRowHeaders() (+12 more)
...
Cohesion: 0.19
Nodes (15): parseCliOptions(), parseTargetOptions(), parseTargetPath(), TargetArgError, __dirname, ensureServerRunning(), globToRegex(), globToRegex() (+7 more)
...
### Community 317 - "Visualize: Direction Comps & Asset Production"
Cohesion: 0.50
...
### Community 320 - ".claude/skills/impeccable/scripts/live/source-lock.mjs"
Cohesion: 0.32
Nodes (8): borderColorsFromStyle(), borderWidthsFromStyle(), checkElementGptBorderShadow(), checkElementGptBorderShadowDOM(), checkGptThinBorderWideShadow(), cssColorAlpha(), shadowLayerAlpha(), shadowMaxBlurPx()
...
Cohesion: 0.06
Nodes (31): AbcBadge, CLS, TITLE, ClearFiltersButton(), ActiveFilter, ColumnFilterBar(), FilterColumn, passesFilters() (+23 more)

### Community 342 - ".opencode/skills/impeccable/scripts/live/browser-script-parts.mjs"
Cohesion: 0.33
...
### Community 345 - "AnalisisPage.tsx"
Cohesion: 0.83
Nodes (3): AnalisisPage(), pct(), qLabelOf()

## Knowledge Gaps
- **1734 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `SEED_MODES` (+1729 more)
...
- **Why does `ev()` connect `class-variance-authority` to `Toaster.tsx`, `catalogService.ts`?**
...
- **Should `mappers.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.03358778625954199 - nodes in this community are weakly interconnected._