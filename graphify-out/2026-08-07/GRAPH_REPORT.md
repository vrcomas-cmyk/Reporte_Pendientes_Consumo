# Graph Report - Reporte_Pendientes_Consumo  (2026-08-06)

## Corpus Check
- 496 files · ~764,344 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7478 nodes · 16668 edges · 337 communities (302 shown, 35 thin omitted)
...
Cohesion: 0.20
Nodes (15): checkForReportSheetsUpdate(), fetchReportSheetsMeta(), fetchReportSheetTab(), fetchReportSheetTabPaginated(), progressListeners, readSyncMeta(), REPORT_SHEET_ROLES, REPORT_SHEETS_URL_ENV (+7 more)
...
Cohesion: 0.36
Nodes (7): BORow, diasDesde(), INV_ALL, INV_COLS, RawRow, SugerenciasPage(), UrgenciaDot()
...
Cohesion: 0.25
Nodes (7): 1. Crear el script, 2. Desplegar, 3. Configurar el portal, 4. Probar, 5. Por qué las 4 pestañas siempre se traen completas (historia del delta), 6. Paginación por chunks (`?limit=`), Apps Script — leer el reporte diario desde Google Sheets
...
Cohesion: 0.11
Nodes (34): buildHeatmap(), computeKpis(), detectInconsistencies(), monthlyInvoicing(), topEjecutivos(), topMateriales(), buildAnalysisResult(), BuildAnalysisResultParams (+26 more)

### Community 91 - "@duckdb/duckdb-wasm"
Cohesion: 0.06
Nodes (39): applyCatalogPriceFallback(), computeBloqueados(), condKey(), buildEnrich(), EMPTY, normCode(), preciosPorCondicion(), buildPrecioDispersion() (+31 more)
...
Cohesion: 0.07
Nodes (50): ABC_THRESHOLDS, AbcClass, AbcClassSummary, AbcEntry, buildAbc(), classify(), EMPTY, sum12m() (+42 more)
...
Cohesion: 0.07
Nodes (30): AbcBadge, CLS, TITLE, ActiveFilter, ColumnFilterBar(), FilterColumn, passesFilters(), valuesOf() (+22 more)
...
Cohesion: 0.15
Nodes (22): extractPlatform(), extractSectionValue(), loadContext(), cli(), COMMON_DEV_PORTS, devServerSignals(), gatherSignals(), gitSignals() (+14 more)
...
Cohesion: 0.32
Nodes (11): resolveTargetSelection(), __dirname, ensureServerRunning(), globToRegex(), globToRegex(), resolveFiles(), liveCli(), missingLiveContext() (+3 more)
...
Cohesion: 0.83
Nodes (3): ConsumoPage(), dateSortValue(), fechaCantCell()
...
## Knowledge Gaps
- **1664 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `SEED_MODES` (+1659 more)
...
- **Why does `ev()` connect `class-variance-authority` to `onAnnotDown`, `catalogService.ts`?**
  _High betweenness centrality (0.376) - this node is a cross-community bridge._
- **Why does `beginEditPin()` connect `onAnnotDown` to `button.tsx`, `class-variance-authority`?**
