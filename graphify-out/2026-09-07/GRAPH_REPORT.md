...
## Corpus Check
- 537 files · ~810,223 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7800 nodes · 17244 edges · 352 communities (318 shown, 34 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 342 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8c465a1`
...
Cohesion: 0.07
Nodes (73): Analytics, AnalyticsCtx, useAnalytics(), buildConsumoIndex(), consFor(), consumoEnrich(), consumoKey(), consumoSerie() (+65 more)
...
### Community 7 - "react"
Cohesion: 0.02
Nodes (33): react, EmptyState, EmptyStateProps, Button, ButtonProps, buttonVariants, Card, CardContent (+25 more)
...
Cohesion: 0.06
Nodes (74): ABC_THRESHOLDS, AbcClass, AbcClassSummary, AbcEntry, AbcPredicates, AbcResult, buildAbc(), classify() (+66 more)
...
Cohesion: 0.06
Nodes (53): blankCssComments(), CSS_IN_JS_EXTENSIONS, detectText(), extFromFilePath(), extractCSSinJS(), extractStyleBlocks(), firstOverusedGoogleFont(), hexChannels() (+45 more)
...
## Knowledge Gaps
- **1788 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `SEED_MODES` (+1783 more)
