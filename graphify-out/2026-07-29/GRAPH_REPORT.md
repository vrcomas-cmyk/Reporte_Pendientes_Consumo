# Graph Report - Reporte_Pendientes_Consumo  (2026-07-29)

## Corpus Check
- 445 files · ~737,312 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7218 nodes · 16223 edges · 331 communities (295 shown, 36 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 334 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ad9446d`
...
- `parseColorMix()` --indirect_call--> `pct()`  [INFERRED]
  .claude/skills/impeccable/scripts/detector/detect-antipatterns-browser.js → src/modules/analisis/AnalisisPage.tsx
- `beginEditPin()` --indirect_call--> `ev()`  [INFERRED]
  .claude/skills/impeccable/scripts/live-browser.js → src/hooks/useKeybindings.test.ts
- `parseColorMix()` --indirect_call--> `pct()`  [INFERRED]
  .opencode/skills/impeccable/scripts/detector/detect-antipatterns-browser.js → src/modules/analisis/AnalisisPage.tsx
- `parseColorMix()` --indirect_call--> `pct()`  [INFERRED]
  .opencode/skills/impeccable/scripts/detector/rules/checks.mjs → src/modules/analisis/AnalisisPage.tsx
- `beginEditPin()` --indirect_call--> `ev()`  [INFERRED]
...
## Communities (331 total, 36 thin omitted)
...
Cohesion: 0.10
Nodes (51): Analytics, AnalyticsCtx, useAnalytics(), consFor(), consumoEnrich(), consumoSerie(), consumoStatus(), consumoTend() (+43 more)
...
### Community 7 - "react"
Cohesion: 0.03
Nodes (22): react, Badge(), BadgeProps, badgeVariants, Button, ButtonProps, buttonVariants, Input (+14 more)
...
### Community 11 - "clsx"
Cohesion: 0.13
Nodes (10): ErrorBoundary, Props, State, ADMIN_NAV_ITEM, NAV, Sidebar(), SidebarProps, TITLE_OVERRIDES (+2 more)
...
Cohesion: 0.10
Nodes (18): AdminPage, AnalisisPage, App(), ComodatoPage, ConsumoPage, DashboardPage, GenerarReportePage, HistoryPage (+10 more)
...
Cohesion: 0.03
Nodes (133): applyGlobalBarLabelState(), applyParamValue(), applyPlaceholderSizingStyles(), applySvelteComponentVariantStyle(), averageRgb01(), bufferToBase64(), buildCollapsible(), buildColorModels() (+125 more)
...
Cohesion: 0.47
Nodes (5): BORow, INV_ALL, INV_COLS, RawRow, SugerenciasPage()
...
Cohesion: 0.25
Nodes (7): 1. Crear el script, 2. Desplegar, 3. Configurar el portal, 4. Probar, 5. Sync incremental (delta), 6. Paginación por chunks (`?limit=`), Apps Script — leer el reporte diario desde Google Sheets
...
Cohesion: 0.10
Nodes (21): class-variance-authority, clsx, dexie, dependencies, class-variance-authority, clsx, dexie, @radix-ui/react-scroll-area (+13 more)
...
Cohesion: 0.04
Nodes (103): ANIMATION_VALUE_KEYWORDS, borderColorsFromStyle(), borderWidthsFromStyle(), checkClippedOverflow(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM(), checkElementClippedOverflow(), checkElementClippedOverflowDOM() (+95 more)
...
Cohesion: 0.07
Nodes (56): eventPriority(), selectAvailablePendingEvent(), acknowledgePendingEvent(), activeSessionSummaries(), agentPollingConnected(), annotRoot, applyLegacyDeferredAcceptsOnStartup(), args (+48 more)
...
Cohesion: 0.08
Nodes (37): applyCatalogPriceFallback(), condKey(), BuildAnalysisResultParams, consumoRow1, consumoRow2, settings, sugerenciaRow, buildEnrich() (+29 more)

### Community 92 - "mappers.ts"
Cohesion: 0.16
Nodes (25): buildHeatmap(), computeKpis(), detectInconsistencies(), monthlyInvoicing(), topEjecutivos(), topMateriales(), buildAnalysisResult(), findSheetByRole() (+17 more)
...
Cohesion: 0.10
Nodes (40): armPageChatForTyping(), attachSteerFocusDebug(), attachSteerFocusGuard(), clearSteerAwaitTimer(), clearSteerFocusRecoverTimer(), collapsePageChat(), expandPageChat(), focusConfigureInput() (+32 more)
...
Cohesion: 0.10
Nodes (36): checkColors(), checkElementAIPaletteDOM(), checkElementGlow(), checkGlow(), checkHoverContrast(), collectCssCustomProps(), collectMarqueeKeyframes(), collectPulseKeyframes() (+28 more)
...
Cohesion: 0.11
Nodes (18): ActiveFilter, ColumnFilterBar(), FilterColumn, passesFilters(), valuesOf(), ColDef, ColumnVisibilityControl(), useColumnVisibility() (+10 more)
...
### Community 198 - "captureElementToBlob"
Cohesion: 0.17
...
Cohesion: 0.14
Nodes (18): xlsx, exportXlsx(), exportXlsxMultiSheet(), peekReportSheets(), ReportSheetInfo, cancelled, firstRowHeaders(), fixRange() (+10 more)
...
### Community 229 - ".opencode/skills/impeccable/scripts/live/event-validation.mjs"
Cohesion: 0.25
Nodes (12): FORBIDDEN_MANUAL_EDIT_TEXT_CHARS, INSERT_POSITIONS, isValidId(), isValidVariantId(), validateAnnotationFields(), validateEvent(), validateInsertGenerate(), validateManualEditEvent() (+4 more)
...
### Community 279 - ".opencode/skills/impeccable/scripts/detector/shared/inline-ignores.mjs"
Cohesion: 0.40
Nodes (9): addRules(), applyInlineIgnores(), getSet(), hasDirectives(), isInlineIgnored(), normalizeRule(), parseInlineIgnores(), parseRuleList() (+1 more)

### Community 280 - "syncEditBadgeHitProxies"
Cohesion: 0.53
...
### Community 292 - ".claude/skills/impeccable/scripts/live/source-lock.mjs"
Cohesion: 0.21
...
### Community 298 - ".opencode/skills/impeccable/scripts/hook.mjs"
Cohesion: 0.27
...
### Community 303 - "serializeFindings"
Cohesion: 0.33
...
### Community 312 - "Visualize: Direction Comps & Asset Production"
Cohesion: 0.33
...
### Community 313 - "checkElementBordersDOM"
Cohesion: 0.47
...
### Community 316 - "/impeccable hooks"
Cohesion: 0.33
Nodes (6): Constraints, Failure modes, Flow, /impeccable hooks, Intentional findings, Routing
...
### Community 318 - "checkElementBordersDOM"
Cohesion: 0.44
...
## Knowledge Gaps
- **1609 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `SEED_MODES` (+1604 more)
...
- **Why does `pct()` connect `resolveVarRefs` to `resolveVarRefs`, `scanCssTextForPulsingDot`, `LocalReportRepository`?**
  _High betweenness centrality (0.203) - this node is a cross-community bridge._
- **Why does `parseColorMix()` connect `resolveVarRefs` to `parseAnyColor`, `@radix-ui/react-scroll-area`?**
