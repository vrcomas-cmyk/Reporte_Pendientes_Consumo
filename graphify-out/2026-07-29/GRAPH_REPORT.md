...
## Corpus Check
- 446 files · ~737,946 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7223 nodes · 16233 edges · 329 communities (294 shown, 35 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 334 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8fa1d2ff`
...
Cohesion: 0.10
Nodes (50): Analytics, AnalyticsCtx, useAnalytics(), consFor(), consumoEnrich(), consumoSerie(), consumoStatus(), consumoTend() (+42 more)
...
### Community 7 - "react"
Cohesion: 0.03
Nodes (21): react, EmptyState, EmptyStateProps, Badge(), BadgeProps, badgeVariants, Input, Progress (+13 more)
...
Cohesion: 0.03
Nodes (130): applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), applySvelteComponentVariantStyle(), attachSteerFocusGuard(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible(), buildColorModels() (+122 more)
...
Cohesion: 0.09
Nodes (45): applyConfigureBarChrome(), armPageChatForTyping(), attachSteerFocusDebug(), clearSteerAwaitTimer(), collapsePageChat(), dismissToast(), expandPageChat(), finishVoiceSession() (+37 more)
...
Cohesion: 0.09
Nodes (23): ActiveFilter, ColumnFilterBar(), FilterColumn, passesFilters(), valuesOf(), ColDef, ColumnVisibilityControl(), useColumnVisibility() (+15 more)
...
Cohesion: 0.21
Nodes (14): averageRgb01(), captureElementFromRenderedAncestor(), captureElementToBlob(), cssColorToRgb01(), dominantRgb01(), findBackdropAncestor(), findShaderProxyCaptureRoot(), isTransparentColor() (+6 more)
...
Cohesion: 0.50
Nodes (4): parseColorMix(), splitTopLevelCommas(), AnalisisPage(), pct()
...
- **Why does `pct()` connect `.opencode/skills/impeccable/reference/bolder.md` to `mappers.ts`, `useAuth.ts`, `LocalReportRepository`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `parseColorMix()` connect `.opencode/skills/impeccable/reference/bolder.md` to `parseAnyColor`, `@radix-ui/react-scroll-area`?**
