# Graph Report - Reporte_Pendientes_Consumo  (2026-08-04)

## Corpus Check
- 459 files · ~750,743 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7299 nodes · 16308 edges · 339 communities (302 shown, 37 thin omitted)
...
Cohesion: 0.09
Nodes (54): Analytics, AnalyticsCtx, useAnalytics(), consFor(), consumoEnrich(), consumoSerie(), consumoStatus(), consumoTend() (+46 more)
...
### Community 7 - "react"
Cohesion: 0.02
Nodes (23): react, COLORS, ICONS, Button, ButtonProps, buttonVariants, Input, PopoverContent (+15 more)
...
Cohesion: 0.10
Nodes (19): AdminPage, AnalisisPage, App(), ComodatoPage, ConsumoPage, DashboardPage, GenerarReportePage, HistoryPage (+11 more)
...
Cohesion: 0.21
Nodes (12): ABC_THRESHOLDS, AbcClass, AbcClassSummary, AbcEntry, AbcResult, buildAbc(), classify(), EMPTY (+4 more)
...
Cohesion: 0.07
Nodes (38): applyCatalogPriceFallback(), computeBloqueados(), condKey(), BuildAnalysisResultParams, consumoRow1, consumoRow2, settings, sugerenciaRow (+30 more)
...
Cohesion: 0.09
Nodes (40): BOItem, buildBO(), hasFuente(), keyOf(), AnalisisFilters, AnalisisResult, analisisVentas(), ClienteAna (+32 more)
...
Cohesion: 0.15
Nodes (17): AbcBadge, CLS, TITLE, ColDef, ColumnVisibilityControl(), readStoredHidden(), useColumnVisibility(), writeStoredHidden() (+9 more)
...
Cohesion: 0.47
Nodes (3): TITLE_OVERRIDES, titleFor(), Topbar()
...
Cohesion: 0.22
Nodes (5): buildRiesgoCaducidad(), RiesgoCaducidadMes, RiesgoCaducidadOptions, conDemandaSet, InvDetalleRow
...
Cohesion: 0.40
Nodes (3): ADMIN_NAV_ITEM, NAV, SidebarProps
...
### Community 316 - "syncEditBadgeHitProxies"
Cohesion: 0.50
...
### Community 331 - ".opencode/skills/impeccable/reference/colorize.md"
Cohesion: 0.67
...
### Community 334 - ".opencode/skills/impeccable/scripts/live/source-search.mjs"
Cohesion: 0.38
...
## Knowledge Gaps
- **1638 isolated node(s):** `1. Crear el script`, `2. Desplegar`, `3. Configurar el portal`, `4. Probar`, `5. Por qué las 4 pestañas siempre se traen completas (historia del delta)` (+1633 more)
...
- **Are the 43 inferred relationships involving `el()` (e.g. with `browserFindingsFromMap()` and `collectVisualContrastCandidates()`) actually correct?**
  _`el()` has 43 INFERRED edges - model-reasoned connections that need verification._
- **What connects `1. Crear el script`, `2. Desplegar`, `3. Configurar el portal` to the rest of the system?**
